     ...
     if open then 
         ...
         while open do 
            RageUI.IsVisible(mainMenu6,function() 
              ...
              RageUI.Button("S'équiper d'un : ~r~Gilet Pare-Balles", nil,{RightLabel = "~"}, true,{
                onSelected = function()
            ...
            RageUI.Button("S'équiper d'un : ~r~Gilet Jaune", nil,{RightLabel = "~"}, true,{
                onSelected = function()
                  AddArmourToPed(playerPed,100)
                  vgilletj()
              end
              ...
              RageUI.Button("S'équiper d'un : ~r~Sac à dos", nil,{RightLabel = "~"}, true,{
                onSelected = function()
                  AddArmourToPed(playerPed,100)
                  vsac()
              end
